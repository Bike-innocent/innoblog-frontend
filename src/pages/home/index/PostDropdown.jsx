...
// import { useQuery, useMutation, useQueryClient } from '@tanstack/react-query'; // React Query v5
...
//   // Fetch saved state using React Query v5
//   const { data: isSaved = false, error } = useQuery({
//     queryKey: ['isSaved', post.slug], // Unique key for caching
//     queryFn: async () => {
//       const response = await axiosInstance.get(`posts/${post.slug}/is-saved`);
//       return response.data.is_saved;
//     },
//     staleTime: 5 * 60 * 1000, // Cache the result for 5 minutes
//     refetchOnWindowFocus: false, // Disable refetch on window focus to avoid unnecessary requests
//     onError: (error) => {
...
//     },
//     onSuccess: (data) => {
//       queryClient.setQueryData(['isSaved', post.slug], data); // Update cached data
