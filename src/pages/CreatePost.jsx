...
//         formData.append('is_publish', isPublish ? 1 : 0); // Include flag to differentiate between draft and publish
...
//                 {/* Content editor, category, sub-category, and image inputs remain unchanged */}
...
//                     {/* Publish Button */}
//                     <button
//                         type="button" // Set type to "button" to avoid triggering form submit
//                         className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"

//                         onClick={(e) => handleSubmit(e, true)} // Pass `true` to handleSubmit for publish
//                     >
//                         Publish
//                     </button>
//                 </div>
